                        ...
                        <div class="col-8">
                            <div class="form-group row">
                                <div class="col-sm-12 input-floating-label text-blue-d1 brc-blue-m1">
                                    <input type="text" value="{{ old('username') }}" class="form-control form-control-md col-sm-12 col-md-12 shadow-none" autocomplete="off" id="post-seotitle" name="username">
                                    <span class="floating-label text-grey-m3">User Name</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 input-floating-label text-blue-d1 brc-blue-m1">
                                    <input type="password" value="{{ old('password') }}" class="form-control form-control-md col-sm-12 col-md-12 shadow-none" autocomplete="off" id="post-password" name="password">
                                    <span class="floating-label text-grey-m3">Password</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 input-floating-label text-blue-d1 brc-blue-m1">
                                    <input type="text" value="{{ old('email') }}" class="form-control form-control-md col-sm-12 col-md-12 shadow-none" autocomplete="off" id="post-seodes" name="email">
                                    <span class="floating-label text-grey-m3">Email</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 input-floating-label text-blue-d1 brc-blue-m1">
                                    <input type="text" value="{{ old('title') }}" class="form-control form-control-md col-sm-12 col-md-12 shadow-none" autocomplete="off" id="post-title" name="title">
                                    <span class="floating-label text-grey-m3">Full Name</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 input-floating-label text-blue-d1 brc-blue-m1">
                                    <input type="text" value="{{ old('phone') }}" class="form-control form-control-md col-sm-12 col-md-12 shadow-none" autocomplete="off" id="post-seokey" name="phone">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 ">
                                    ...
                                    <label>
                                        <input type="radio" name="status" value="active" class="text-success">
                                        Active
                                    </label>
                                    <label>
                                        <input type="radio" checked name="status" value="inactive" class="text-danger">
                                        Inactive
                                    </label>
                                </div>
                            </div>
