            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="text" class="form-control" name="slug" id="post-slug" value="{{ $item['slug']? $item['slug']: old('title') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-3">
                    ...
                    <div class="card radius-0 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <select name="ishome" id="post-ishome" class="form-control">
                                        @php
                                            $select1 = $item["ishome"] == "yes"? "selected":"";
                                            $select2 = $item['ishome'] == 'no'? 'selected':'';
                                        @endphp
                                        <option value="yes" {{ $select1  }}>Yes</option>
                                        <option value="no"  {{ $select2  }}>No</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <select name="display" id="post-display" class="form-control">
                                        @php
                                            $select1 = $item["display"] == "list"? "selected":"";
                                            $select2 = $item['display'] == 'grid'? 'selected':'';
                                        @endphp
                                        <option value="list" {{ $select1  }}>List</option>
                                        <option value="grid"  {{ $select2  }}>Grid</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="number" name="ordering" value="{{ $item['ordering']? $item['ordering']: 0}}" class="form-control">
                                </div>
                            </div>   
                        </div>
